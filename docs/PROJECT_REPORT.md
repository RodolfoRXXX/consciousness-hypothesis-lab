...
La formulación de la sección 1 y las revisiones históricas de la sección 9 quedan como antecedentes de la hipótesis inicial, no como compromiso de implementar todos los módulos enumerados. El [alcance V1](experiments/v1-developmental-scope.md) responde provisionalmente qué contiene `Agent(t0)`, qué función de aprendizaje se requiere y qué controles y falsadores preceden a la implementación; algoritmos, representaciones y módulos concretos siguen abiertos. El [marco de procedencia](development/inheritance-learning-emergence.md) conserva la clasificación metodológica general.
